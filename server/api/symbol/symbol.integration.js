...
describe('Symbol API:', function() {
  describe('GET /api/symbols', function() {
    ...
    it('should respond with JSON array', function() {
      symbols.should.be.instanceOf(Array);
    });
  });
  ...
  describe('POST /api/symbols', function() {
    ...
    it('should respond with the newly created symbol', function() {
      newSymbol.name.should.equal('New Symbol');
      newSymbol.info.should.equal('This is the brand new symbol!!!');
    });
  });
  ...
  describe('GET /api/symbols/:id', function() {
    ...
    it('should respond with the requested symbol', function() {
      symbol.name.should.equal('New Symbol');
      symbol.info.should.equal('This is the brand new symbol!!!');
    });
  });
  ...
  describe('PUT /api/symbols/:id', function() {
    ...
    it('should respond with the updated symbol', function() {
      updatedSymbol.name.should.equal('Updated Symbol');
      updatedSymbol.info.should.equal('This is the updated symbol!!!');
    });
    ...
    it('should respond with the updated symbol on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          symbol.name.should.equal('Updated Symbol');
          symbol.info.should.equal('This is the updated symbol!!!');
  ...
  describe('PATCH /api/symbols/:id', function() {
    ...
    it('should respond with the patched symbol', function() {
      patchedSymbol.name.should.equal('Patched Symbol');
      patchedSymbol.info.should.equal('This is the patched symbol!!!');
    });
  });
